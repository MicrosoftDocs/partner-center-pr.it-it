...
### <a name="categories"></a><span data-ttu-id="f9997-107">Categorie</span><span class="sxs-lookup"><span data-stu-id="f9997-107">Categories</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="f9997-155">Destinatari interessati</span><span class="sxs-lookup"><span data-stu-id="f9997-155">Impacted audience</span></span>
...
<span data-ttu-id="f9997-168">In breve, i file dei prezzi seguenti saranno disponibili come di consueto il 31 dicembre 2020 alle 18.00 (ora solare Pacifico):</span><span class="sxs-lookup"><span data-stu-id="f9997-168">In summary, the below pricing files will be available as usual on December 31, 2020 at approximately 6PM PST:</span></span>
...
- <span data-ttu-id="f9997-182">Data: 21-12-2020</span><span class="sxs-lookup"><span data-stu-id="f9997-182">Date: 2020-12-21</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="f9997-196">Passaggi successivi</span><span class="sxs-lookup"><span data-stu-id="f9997-196">Next steps</span></span>
...
<span data-ttu-id="f9997-207">Tutti i partner CSP</span><span class="sxs-lookup"><span data-stu-id="f9997-207">All CSP partners</span></span>
...
2. <span data-ttu-id="f9997-226">Il partner opera con clienti nuovi o esistenti nei paesi seguenti:</span><span class="sxs-lookup"><span data-stu-id="f9997-226">The partner does business with new or existing customers in the following countries:</span></span>
    ...
    - <span data-ttu-id="f9997-239">Venezuela</span><span class="sxs-lookup"><span data-stu-id="f9997-239">Venezuela</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="f9997-256">Passaggi successivi</span><span class="sxs-lookup"><span data-stu-id="f9997-256">Next steps</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="f9997-316">Destinatari interessati</span><span class="sxs-lookup"><span data-stu-id="f9997-316">Impacted audience</span></span>
...
### <a name="categories"></a><span data-ttu-id="f9997-326">Categorie</span><span class="sxs-lookup"><span data-stu-id="f9997-326">Categories</span></span>
...
<span data-ttu-id="f9997-341">**Dettagli sui prezzi**</span><span class="sxs-lookup"><span data-stu-id="f9997-341">**Pricing details**</span></span>
...
<span data-ttu-id="f9997-428">Questa offerta è stata inclusa nella matrice dell'elenco di offerte, ma non nel listino prezzi di dicembre.</span><span class="sxs-lookup"><span data-stu-id="f9997-428">This offer was included in the offer list matrix but not the December price list.</span></span> <span data-ttu-id="f9997-429">L'offerta è disponibile e i prezzi sono reperibili nel file del listino prezzi del mese di novembre.</span><span class="sxs-lookup"><span data-stu-id="f9997-429">The offer is available and pricing can be found in the previous month's price list November file.</span></span> <span data-ttu-id="f9997-430">Questa offerta dovrebbe essere nuovamente aggiunta al listino prezzi di gennaio.</span><span class="sxs-lookup"><span data-stu-id="f9997-430">This offer should be added back to the January price list.</span></span>

   |<span data-ttu-id="f9997-431">**Nome offerta**</span><span class="sxs-lookup"><span data-stu-id="f9997-431">**Offer name**</span></span>|<span data-ttu-id="f9997-432">**ID offerta**</span><span class="sxs-lookup"><span data-stu-id="f9997-432">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="f9997-433">Power Apps - Piano per app</span><span class="sxs-lookup"><span data-stu-id="f9997-433">Power Apps per app plan</span></span>|<span data-ttu-id="f9997-434">5e1087b6-246b-4503-b88a-b60bdf0b3840</span><span class="sxs-lookup"><span data-stu-id="f9997-434">5e1087b6-246b-4503-b88a-b60bdf0b3840</span></span>|

### <a name="next-steps"></a><span data-ttu-id="f9997-435">Passaggi successivi</span><span class="sxs-lookup"><span data-stu-id="f9997-435">Next steps</span></span>

<span data-ttu-id="f9997-436">Controllare spesso le note sulla versione, in quanto eventuali nuovi problemi verranno aggiunti a questo annuncio.</span><span class="sxs-lookup"><span data-stu-id="f9997-436">Check release notes often as other issues are uncovered they will be appended to this announcement.</span></span>

### <a name="last-updated"></a><span data-ttu-id="f9997-437">Ultimo aggiornamento</span><span class="sxs-lookup"><span data-stu-id="f9997-437">Last updated</span></span>

<span data-ttu-id="f9997-438">8 dicembre 2020</span><span class="sxs-lookup"><span data-stu-id="f9997-438">December 8, 2020</span></span>

______________

## <a name="an-update-of-the-us-microsoft-365-business-voice-with-calling-plan-offer-is-coming-soon"></a><a name="2"></a><span data-ttu-id="f9997-439">Aggiornamento dell'offerta Microsoft 365 Business Voice per gli Stati Uniti con piano per chiamate presto disponibile</span><span class="sxs-lookup"><span data-stu-id="f9997-439">An update of the US Microsoft 365 Business Voice with Calling Plan offer is coming soon</span></span>

### <a name="categories"></a><span data-ttu-id="f9997-440">Categorie</span><span class="sxs-lookup"><span data-stu-id="f9997-440">Categories</span></span>

- <span data-ttu-id="f9997-441">Data: 3-12-2020</span><span class="sxs-lookup"><span data-stu-id="f9997-441">Date: 2020-12-3</span></span>
- <span data-ttu-id="f9997-442">Offerte/mercati</span><span class="sxs-lookup"><span data-stu-id="f9997-442">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="f9997-443">Riepilogo</span><span class="sxs-lookup"><span data-stu-id="f9997-443">Summary</span></span> 

<span data-ttu-id="f9997-444">Il 1° gennaio 2021, Microsoft inizierà la transizione dei partner e dei clienti degli Stati Uniti a una nuova offerta di Microsoft 365 Business Voice con piano per chiamate.</span><span class="sxs-lookup"><span data-stu-id="f9997-444">On January 1, 2021, Microsoft will begin transitioning US partners and customers to a new Microsoft 365 Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="f9997-445">Non è richiesta alcuna azione da parte del partner.</span><span class="sxs-lookup"><span data-stu-id="f9997-445">No partner action is required.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f9997-446">Destinatari interessati</span><span class="sxs-lookup"><span data-stu-id="f9997-446">Impacted Audience</span></span> 

<span data-ttu-id="f9997-447">Tutti i partner che eseguono transazioni tramite il programma Cloud Solution Provider (CSP)</span><span class="sxs-lookup"><span data-stu-id="f9997-447">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="f9997-448">Dettagli</span><span class="sxs-lookup"><span data-stu-id="f9997-448">Details</span></span>

<span data-ttu-id="f9997-449">Microsoft sostituirà l'offerta Business Voice con piano per chiamate esistente negli Stati Uniti con una nuova offerta, allo scopo di supportare i requisiti interni per i prodotti Telco.</span><span class="sxs-lookup"><span data-stu-id="f9997-449">Microsoft will replace the existing Business Voice with Calling plan offer in the US with a new offer to support internal requirements for telco products.</span></span> <span data-ttu-id="f9997-450">Il set di funzionalità e i prezzi della nuova offerta saranno identici.</span><span class="sxs-lookup"><span data-stu-id="f9997-450">The new offer will have the same feature set and pricing.</span></span> <span data-ttu-id="f9997-451">Le modifiche dell'offerta sono interne a Microsoft e non devono influire sul modo in cui i partner CSP commercializzano, vendono o supportano l'offerta Business Voice con piano per chiamate.</span><span class="sxs-lookup"><span data-stu-id="f9997-451">The offer changes are internal to Microsoft and should not affect the way that CSP partners market, sell, or support the Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="f9997-452">La modifica si applicherà solo a questa offerta.</span><span class="sxs-lookup"><span data-stu-id="f9997-452">The change will only apply to this offer.</span></span>

<span data-ttu-id="f9997-453">Per le nuove vendite, si userà la nuova offerta a partire dal 1° gennaio 2021.</span><span class="sxs-lookup"><span data-stu-id="f9997-453">For new sales, you will use the new offer starting on January 1, 2021.</span></span> <span data-ttu-id="f9997-454">Nel listino prezzi, l'offerta precedente verrà sostituita dalla nuova offerta.</span><span class="sxs-lookup"><span data-stu-id="f9997-454">The old offer will be replaced by the new offer on the price list.</span></span>

<span data-ttu-id="f9997-455">I clienti esistenti verranno automaticamente passati alla nuova offerta alla data di rinnovo.</span><span class="sxs-lookup"><span data-stu-id="f9997-455">Existing customers will be automatically transitioned to the new offer upon their renewal date.</span></span> <span data-ttu-id="f9997-456">Non è richiesta alcuna azione da partner e clienti che effettuano il rinnovo.</span><span class="sxs-lookup"><span data-stu-id="f9997-456">No action is required from partners and renewing customers.</span></span>


<span data-ttu-id="f9997-457">\*\*Dettagli della nuova offerta</span><span class="sxs-lookup"><span data-stu-id="f9997-457">\*\*New offer details</span></span>
 
   |<span data-ttu-id="f9997-458">**Nome offerta**</span><span class="sxs-lookup"><span data-stu-id="f9997-458">**Offer name**</span></span>|<span data-ttu-id="f9997-459">**ID offerta**</span><span class="sxs-lookup"><span data-stu-id="f9997-459">**Offer ID**</span></span>|<span data-ttu-id="f9997-460">**ID materiale**</span><span class="sxs-lookup"><span data-stu-id="f9997-460">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="f9997-461">Microsoft 365 Business Voice (USA)</span><span class="sxs-lookup"><span data-stu-id="f9997-461">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="f9997-462">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span><span class="sxs-lookup"><span data-stu-id="f9997-462">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span></span>|<span data-ttu-id="f9997-463">PZW-00023</span><span class="sxs-lookup"><span data-stu-id="f9997-463">PZW-00023</span></span>|
   
<span data-ttu-id="f9997-464">\*\*Dettagli dell'offerta precedente</span><span class="sxs-lookup"><span data-stu-id="f9997-464">\*\*Old offer details</span></span>

   |<span data-ttu-id="f9997-465">**Nome offerta**</span><span class="sxs-lookup"><span data-stu-id="f9997-465">**Offer name**</span></span>|<span data-ttu-id="f9997-466">**ID offerta**</span><span class="sxs-lookup"><span data-stu-id="f9997-466">**Offer ID**</span></span>|<span data-ttu-id="f9997-467">**ID materiale**</span><span class="sxs-lookup"><span data-stu-id="f9997-467">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="f9997-468">Microsoft 365 Business Voice (USA)</span><span class="sxs-lookup"><span data-stu-id="f9997-468">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="f9997-469">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span><span class="sxs-lookup"><span data-stu-id="f9997-469">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span></span>|<span data-ttu-id="f9997-470">PZW-00009</span><span class="sxs-lookup"><span data-stu-id="f9997-470">PZW-00009</span></span>|

### <a name="next-steps"></a><span data-ttu-id="f9997-471">Passaggi successivi</span><span class="sxs-lookup"><span data-stu-id="f9997-471">Next steps</span></span>

<span data-ttu-id="f9997-472">Acquisire familiarità con il listino prezzi e condividere queste informazioni con tutti i contatti appropriati nella propria organizzazione.</span><span class="sxs-lookup"><span data-stu-id="f9997-472">Familiarize yourself with the price list and share this information with all appropriate contacts in your organization.</span></span>

______________

## <a name="now-live-partner-center-api-updates-and-user-interface-enhancements-for-the-education-customer-validation-process"></a><a name="1"></a><span data-ttu-id="f9997-473">Ora disponibile: aggiornamenti delle API e miglioramenti dell'interfaccia utente del Centro per i partner per il processo di convalida dei clienti del settore della formazione</span><span class="sxs-lookup"><span data-stu-id="f9997-473">Now live: Partner Center API updates and user interface enhancements for the Education customer validation process</span></span>

### <a name="categories"></a><span data-ttu-id="f9997-474">Categorie</span><span class="sxs-lookup"><span data-stu-id="f9997-474">Categories</span></span>

- <span data-ttu-id="f9997-475">Data: 3-12-2020</span><span class="sxs-lookup"><span data-stu-id="f9997-475">Date: 2020-12-3</span></span>
- <span data-ttu-id="f9997-476">Funzionalità</span><span class="sxs-lookup"><span data-stu-id="f9997-476">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="f9997-477">Destinatari interessati</span><span class="sxs-lookup"><span data-stu-id="f9997-477">Impacted Audience</span></span> 

<span data-ttu-id="f9997-478">Partner che vendono offerte per il settore accademico tramite il programma Cloud Solution Provider</span><span class="sxs-lookup"><span data-stu-id="f9997-478">Partners selling Academic offers through the Cloud Solution Provider program</span></span>

### <a name="summary"></a><span data-ttu-id="f9997-479">Riepilogo</span><span class="sxs-lookup"><span data-stu-id="f9997-479">Summary</span></span> 

<span data-ttu-id="f9997-480">Microsoft</span><span class="sxs-lookup"><span data-stu-id="f9997-480">Microsoft runs on trust.</span></span> <span data-ttu-id="f9997-481">Microsoft si impegna a fornire un metodo di convalida dei clienti conforme e sicuro per la vendita di offerte per il settore accademico nel programma Cloud Solution Provider.</span><span class="sxs-lookup"><span data-stu-id="f9997-481">We are committed to providing a compliant, safe, and secure method of customer validation for transacting Academic offers in the Cloud Solution Provider program.</span></span> <span data-ttu-id="f9997-482">Nell'ambito di questo impegno, verranno introdotti miglioramenti all'interfaccia utente e all'API del Centro per i partner. Tali miglioramenti aggiungeranno chiarezza e visibilità al processo di verifica dei clienti, nonché la possibilità di inserire dati più accurati che consentiranno di migliorare il processo di analisi dei clienti.</span><span class="sxs-lookup"><span data-stu-id="f9997-482">As part of this commitment, we are introducing Partner Center API and user interface enhancements that will add clarity and visibility into the customer vetting process as well as the ability to input more accurate data, which will drive improved customer vetting success.</span></span> 

<span data-ttu-id="f9997-483">**Miglioramenti del Centro per i partner**</span><span class="sxs-lookup"><span data-stu-id="f9997-483">**Partner Center enhancements**</span></span> 

- <span data-ttu-id="f9997-484">Nuove API di qualifica GET e POST per supportare l'inserimento preciso dei dati e migliorare il processo di convalida dei clienti del settore della formazione da parte di Microsoft.</span><span class="sxs-lookup"><span data-stu-id="f9997-484">New GET and POST Qualifications APIs to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

- <span data-ttu-id="f9997-485">Miglioramenti dell'interfaccia utente per supportare l'inserimento preciso dei dati e migliorare il processo di convalida dei clienti del settore della formazione da parte di Microsoft.</span><span class="sxs-lookup"><span data-stu-id="f9997-485">User interface enhancements to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

<span data-ttu-id="f9997-486">**Deprecazione delle API di qualifica GET e PUT esistenti**</span><span class="sxs-lookup"><span data-stu-id="f9997-486">**Deprecation of existing GET and PUT Qualification APIs**</span></span> 

<span data-ttu-id="f9997-487">Le API di qualifica GET e PUT esistenti verranno ritirate **prima della fine di febbraio 2021**.</span><span class="sxs-lookup"><span data-stu-id="f9997-487">The existing GET and PUT Qualification APIs will retire **before the end of February 2021**.</span></span> <span data-ttu-id="f9997-488">Entro tale data, sarà necessario passare alle nuove API del Centro per i partner GET e POST per poter acquistare offerte del settore della formazione.</span><span class="sxs-lookup"><span data-stu-id="f9997-488">At that time, you will need to have transitioned to the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span>  

<span data-ttu-id="f9997-489">Test</span><span class="sxs-lookup"><span data-stu-id="f9997-489">**Testing**</span></span> 

<span data-ttu-id="f9997-490">Per una migliore comprensione delle API e dell'inserimento dei dati necessari per la corretta convalida dei clienti, i partner possono testare questi miglioramenti.</span><span class="sxs-lookup"><span data-stu-id="f9997-490">To gain a better understanding of the APIs and data entry required for successful customer validation, partners can test these enhancements.</span></span> <span data-ttu-id="f9997-491">I partner che intendono partecipare alla fase di test dovranno scaricare la [guida ai test per i clienti del settore della formazione del Centro per i partner](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) in cui troveranno informazioni su come prepararsi, come iscriversi e cosa aspettarsi durante la fase di test.</span><span class="sxs-lookup"><span data-stu-id="f9997-491">Partners who want to participate in the testing should download the [Partner Center Education customer testing guide](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) for directions on how to prepare, sign up, and for information on what to expect during the testing phase.</span></span>

<span data-ttu-id="f9997-492">**Clienti del settore biblioteche e musei**</span><span class="sxs-lookup"><span data-stu-id="f9997-492">**Library and Museum customers**</span></span> 

<span data-ttu-id="f9997-493">Oltre ai miglioramenti descritti in precedenza, Microsoft è lieta di annunciare che verranno abilitate offerte a prezzo accademico per biblioteche e musei, espandendo i clienti del settore della formazione con cui è possibile eseguire transazioni CSP.</span><span class="sxs-lookup"><span data-stu-id="f9997-493">In addition to the above enhancements, we are excited to announce that we will enable Academic-priced offers for Library and Museum customers, expanding the Education customers with whom you can transact CSP offers.</span></span> 

<span data-ttu-id="f9997-494">Microsoft si riserva il diritto di esaminare lo stato di qualsiasi cliente effettivo o potenziale per verificarne i requisiti di utente del settore della formazione.</span><span class="sxs-lookup"><span data-stu-id="f9997-494">Microsoft reserves the right to review the status of any customer or proposed customer as a qualified educational user.</span></span> <span data-ttu-id="f9997-495">Per informazioni dettagliate, vedere i [requisiti dell'utente qualificato del settore della formazione](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span><span class="sxs-lookup"><span data-stu-id="f9997-495">See the [Academic Qualified Education User Requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7) for full details.</span></span> 

### <a name="next-stepsadditional-resources"></a><span data-ttu-id="f9997-496">Passaggi successivi/Risorse aggiuntive</span><span class="sxs-lookup"><span data-stu-id="f9997-496">Next steps/additional resources</span></span>

- <span data-ttu-id="f9997-497">Vedere la nuova interfaccia utente del Centro per i partner, le modifiche apportate alle API e la guida nelle risorse per l'idoneità per le operazioni:  Miglioramenti del processo di [convalida dei clienti del settore della formazione nel Centro per i partner](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)</span><span class="sxs-lookup"><span data-stu-id="f9997-497">Review the new Partner Center User Interface, API changes, and Guide in the Operations Readiness resources:  [Partner Center Education customer validation](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/) process enhancements</span></span> 

- <span data-ttu-id="f9997-498">Verificare che l'organizzazione conosca i [requisiti dell'utente qualificato del settore della formazione](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span><span class="sxs-lookup"><span data-stu-id="f9997-498">Ensure your organization is familiar with the [Academic Qualified Education User requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span></span> 

- <span data-ttu-id="f9997-499">Condividere queste informazioni con i team appropriati all'interno dell'organizzazione e con i rivenditori, per aiutarli nella preparazione per queste modifiche.</span><span class="sxs-lookup"><span data-stu-id="f9997-499">Share this information with the appropriate teams within your organization, and with your resellers, to help them prepare for these changes.</span></span> 

### <a name="change-log"></a><span data-ttu-id="f9997-500">Registro delle modifiche</span><span class="sxs-lookup"><span data-stu-id="f9997-500">Change Log</span></span> 

<span data-ttu-id="f9997-501">31 agosto 2020:  pubblicazione originale</span><span class="sxs-lookup"><span data-stu-id="f9997-501">_ August 31, 2020:  Original publication</span></span> 

- <span data-ttu-id="f9997-502">25 settembre 2020:  aggiunta dell'aggiornamento della finestra di test</span><span class="sxs-lookup"><span data-stu-id="f9997-502">September 25, 2020:  Test window update added</span></span> 

- <span data-ttu-id="f9997-503">4 ottobre 2020: promemoria per iscriversi ai test</span><span class="sxs-lookup"><span data-stu-id="f9997-503">October 4, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="f9997-504">10 novembre 2020: promemoria per iscriversi ai test</span><span class="sxs-lookup"><span data-stu-id="f9997-504">November 10, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="f9997-505">3 dicembre 2020: aggiornamenti delle API in tempo reale</span><span class="sxs-lookup"><span data-stu-id="f9997-505">December 3, 2020: API updates live</span></span>