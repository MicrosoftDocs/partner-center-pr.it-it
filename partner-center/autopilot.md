...
- [<span data-ttu-id="009f3-112">Guida di riferimento di distribuzione AutoPilot</span><span class="sxs-lookup"><span data-stu-id="009f3-112">Autopilot deployment reference guide</span></span>](https://assetsprod.microsoft.com/autopilot-deployment-program-reference-guide-csp.docx)  
