...
Adesso, grazie alle istanze di macchina virtuale riservate in CSP, i clienti commerciali possono risparmiare fino al 72% rispetto alle tariffe di una macchina virtuale di Azure con pagamento in base al consumo semplicemente acquistando, o "prenotando", la macchina virtuale per un periodo di 1 o 3 anni. I clienti di Windows Server con vantaggio Azure Hybrid, incluso con Software Assurance, saranno in grado di risparmiare fino all'80% rispetto alle tariffe.  
...
-   (Aggiornato) [Istanze riservate di Azure + sottoscrizioni Server domande frequenti](https://www.yammer.com/cloudpartnercommunity/#/files/141644205)
...
-   Azure prenotazioni listino che si trova nella sezione **Prenotazioni di Azure** della pagina Centro per i Partner [prezzi e offerte](http://assetsprod.microsoft.com/modern-offers-country-currency-availability.xlsx) .
-   Server sottoscrizioni listino intitolata "Sottoscrizioni Software" e che si trova nella sezione **Software** della pagina Centro per i Partner [prezzi e offerte](https://commercial-licensing.eventbuilder.com/Reserved_Instances_in_CSP_May_Option_1) .
...
Il [Vantaggio Azure Hybrid](https://azure.microsoft.com/en-us/pricing/hybrid-benefit) consente di ottenere più valore dalle licenze di Windows Server e risparmiare fino a * 47% sulle macchine virtuali. Puoi utilizzare il vantaggio con Windows Server Datacenter e licenze Standard Edition con copertura Software Assurance. A seconda dell'edizione, puoi convertire o riutilizzare le tue licenze per eseguire macchine virtuali di Windows Server in Azure e pagare un costo di calcolo di base inferiore (i costi delle macchine virtuali Linux).
...
-   Risparmia fino al 30% * sulle migrazioni al Database SQL di Azure con vantaggio Azure Hybrid
-   Risparmia fino a 49% in una macchina virtuale IaaS SQL dal risparmio di sovrapposizione tramite una sottoscrizione SQL RI + Windows Server
