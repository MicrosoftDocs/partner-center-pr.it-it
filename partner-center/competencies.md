...
## <a href="" id="attainment_paths"></a> Percorsi di competenze

[Requisiti per l'appartenenza a silver e gold](learn-about-competencies.md)
...
Per controllare lo stato di avanzamento in una competenza, dalla Partner Center Centro per i Partner, vedere la **Partnership > competenze**. 

### <a href="" id="associating_achievements"></a>Ottenere i dipendenti connessi agli obiettivi completati basato su competenze

1.  Aggiungi gli account utente per i dipendenti nell'organizzazione. Dal [Centro per i Partner](https://partnercenter.microsoft.com)passare alla **impostazioni Account > Aggiungi utente**. (gli utenti PMC possono aggiungere più utenti alla volta selezionando **Aggiungi utenti che utilizzano dati PMC**).
...
2. Chiedi ai dipendenti nell'organizzazione di accedere e associare il proprio account Microsoft (MSA) all'account utente. (Dal [Centro per i Partner](https://partnercenter.microsoft.com)passare alla **impostazioni Account**.) I dipendenti possono usare l'account del servizio gestito uguali o diversi per associare gli esami tecnici Microsoft e le certificazioni e i propri account tramite Microsoft Partner University.
...
### <a href="" id="maintain_membership"></a> Gestire e rinnovare l'appartenenza
...
Se viene visualizzato l'avviso: **"Una modifica recente alla realizzazione di una conoscenza è attivata l'idoneità di rinnovo di appartenenza a rischio"**, ciò significa che uno o più di tutti gli obiettivi con competenze sono scadere. 
