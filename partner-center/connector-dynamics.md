...
1. Al termine dell'installazione, tornare alla [Power Automate](https://flow.microsoft.com) e selezionare **Soluzioni** a sinistra. **Partner Center la sincronizzazione delle segnalazioni per Dynamics 365** è ora disponibile **nell'elenco Soluzioni.**
...
1. Sarà necessario creare connessioni che associano i tre account utente:
   ...
   1. Creare quindi una connessione Partner Center eventi per l'utente Partner Center con le credenziali di amministratore segnalazioni.
...
- Campi **lead:** se nel  lead sono presenti campi obbligatori che devono essere popolati, modificare [Personalizza] Crea o Ottieni dettagli dal flusso **di Dynamics 365** e passare a Crea o aggiorna lead **in** CRM e aggiornare Crea un nuovo lead **per** assegnare valori ai campi obbligatori in base ai requisiti aziendali.
