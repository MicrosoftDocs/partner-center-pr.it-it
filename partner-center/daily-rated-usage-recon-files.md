...
| Tier2MpnId | Identificatore MPN del rivenditore del record per la sottoscrizione. Non disponibile per l'attività corrente. |
...
| ChargeType | Tipo di addebito o rettifica. Non disponibile per l'attività corrente. |
...
| UnitType | Tipo di unità in cui viene addebitato il contatore. Non disponibile per l'attività corrente. |
