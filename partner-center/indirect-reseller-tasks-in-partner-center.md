...
> [!NOTE]  
> Se sei già registrato nel programma CSP, potrebbe essere necessario fornire supporto tecnico solo le informazioni per creare un account rivenditore nel centro per i Partner di contatto. 

### <a name="before-you-begin"></a>Prima di iniziare

Se sei nuovo del programma CSP, dovrai iscriverti al programma come rivenditore indiretto e creare un account nel centro per i Partner. A tale scopo, durante il processo di registrazione dovrai fornire le informazioni seguenti. Prima di iniziare, è consigliabile dedicare qualche minuto alla raccolta di questi elementi:

-   **Credenziali di amministratore globale per il tuo account aziendale**<br>
Dovrai fornire il nome utente e password che usi per accedere a Office 365, Microsoft Azure o Microsoft Dynamics CRM. Se non disponi ancora di un account aziendale, puoi crearne uni durante il processo di registrazione. Se non sai se hai già un account aziendale, vedi [account aziendali e Centro per i Partner](azure-active-directory-tenants-and-partner-center.md).


-   **Il nome utente e la password usati per accedere al sito Partner Membership Center**<br>
Usiamo queste informazioni per il collegamento ID dell'organizzazione Microsoft Partner Network (ID MPN) al nuovo account di Centro per i Partner, in modo che tu possa gestire i vantaggi dell'adesione e i dati nel centro per i Partner.
...
4.  Leggi le informazioni su come associare l'ID del Microsoft Partner Network (ID MPN) al nuovo account del Centro per i partner. Dobbiamo collegare l'ID MPN dell'organizzazione al nuovo account di Centro per i Partner, in modo che tu possa gestire i vantaggi dell'adesione e incentivi nel centro per i Partner. Seleziona **Accedi**.
...
1. Nel **Centro per i Partner**, seleziona l'icona **delle impostazioni** e quindi seleziona **gestione degli utenti**.
...
> 
> L'utente dovrà accedere al centro per i Partner con il nome utente e password temporanea. Quando l'utente accede al centro per i Partner per la prima volta, viene richiesto di modificare la password.        
...
Se non lavori ancora con un provider (noto anche come distributore), puoi avviare una [ricerca nell'elenco dei provider ufficiali Microsoft](https://partnercenter.microsoft.com/en-us/partner/find-a-provider) per individuarne uno. Quando avrai individuato un provider con cui collaborare, contattalo direttamente per parlare di programmi per i rivenditori, livelli di supporto e condizioni. Se te e con il provider desiderate collaborare, dovrai connetterti account nel centro per i Partner. 

Qualora un provider indiretto desiderasse connettersi con te nel centro per i Partner, avvierà il flusso di lavoro seguente:
...
4.  Seleziona il menu del **Centro per i Partner** per visualizzare un elenco dei provider che hai stabilito una partnership con **i provider indiretti** . 
...
Per eseguire transazioni con i clienti nel centro per i Partner, i clienti devono disporre gli account del centro per i Partner ed è necessario stabilire con essi relazioni come rivenditori. Per consentire al provider indiretto di acquistare sottoscrizioni e servizi per conto del cliente, anche il provider deve avere relazioni come rivenditore con i clienti. 

### <a name="connect-with-existing-customers"></a>Entrare in contatto con i clienti

I clienti che già Esegui transazioni tramite altri portali, ad esempio di amministrazione partner di Office 365 o portale di amministrazione di Microsoft Azure, verranno visualizzati nell'elenco dei clienti nel centro per i Partner dopo che avrai eseguito la registrazione come rivenditore indiretto. Seleziona **clienti** dal menu del **Centro per i Partner** per visualizzare l'elenco dei clienti. 
...
Quando Attrai nuovi clienti, dovrai connetterti con loro nel centro per i Partner. Puoi acquisire nuovi clienti tramite più canali, tra cui:
...
1.  Seleziona **i provider indiretti** il **menu del centro per i Partner**.
...
[Informazioni sugli incentivi per i partner nel Centro per i partner](manage-your-incentives-in-partner-center.md)
