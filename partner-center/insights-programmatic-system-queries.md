...
---
# <a name="list-of-system-queries-for-partner-insights-programmatic-access"></a>Elenco di query di sistema per l'accesso a livello di codice alle informazioni dettagliate sui partner

Le query di sistema seguenti possono essere usate [nell'API Di](insights-programmatic-access-paradigm.md#create-report-api) creazione report direttamente con un Elemento QueryId. Le query di sistema sono simili ai report di esportazione Partner Center per un periodo di calcolo di sei mesi (6 milioni).

Per altri dettagli sui nomi di colonna, gli attributi e la descrizione, vedere Definizioni [dei dati](insights-data-definitions.md)

Nelle sezioni seguenti vengono fornite query sui report per vari report.

## <a name="customers"></a>Clienti

Report Clienti degli ultimi sei mesi

ID query: `6664daf3-c161-423a-92a1-0ea6db2c0384`

### <a name="report-query"></a>Query di report
```sql
...
## <a name="seats-subscriptions-and-revenue"></a>Sottoscrizioni di postazioni e ricavi

Report su postazioni, sottoscrizioni e ricavi per gli ultimi sei mesi

ID query: `c9fc1c79-4408-49ff-97f9-e1aa3f155804`
...
ID query: `e65f3a4f-fb99-4319-97ff-59e57566a871`
...
Report AzureUsage per gli ultimi sei mesi

ID query: `d1a4d75e-5ca8-4847-845f-ee0a9be6f07b`
...
## <a name="office-usage"></a>Office Utilizzo

Report OfficeUsage per gli ultimi sei mesi

ID query: `d8349f7b-a7d1-467e-b26d-434d4a50f26a`
...
## <a name="dynamics-usage"></a>Utilizzo di Dynamics

Report DynamicsUsage per sei mesi

ID query: `6209a8fd-93af-442e-8b3f-3df0f77e8463`
...
## <a name="power-bi-usage"></a>Utilizzo di Power BI

Report PowerBIUsage per sei mesi

ID query: `40ebfe2f-7183-4427-a911-5c9b45b6df15`
...
## <a name="ems-usage"></a>Utilizzo di EMS

Report EMSUsage per sei mesi

ID query: `d7f20ea4-8751-4d6b-b1d7-821c316acd6a`
...
## <a name="competency-performance-requirement-report"></a>Report dei requisiti di prestazioni delle competenze

Report CompetencyPeformanceRequirement per sei mesi

ID query: `3a0e1adc-f5c1-42ac-9422-8e944bf81ae5`
...
## <a name="cloud-products-reseller-performance"></a>Prestazioni dei rivenditori di prodotti cloud

### <a name="report-description"></a>Descrizione del report

Report CloudProductsResellerPerformance per sei mesi

ID query: `c09c2eda-861b-4664-8ee8-48a14745a26a`
...
## <a name="clas-agreement-renewal-propensity"></a>Tendenza al rinnovo dell'accordo CLAS

Report CLASAgreementRenewalsPropensity per sei mesi

ID query: `c4fc87ac-4cca-44cd-bf4d-835ac513f9ee`
...
## <a name="clas-azure-propensity"></a>CLAS Azure concisa

Report CLASAzurePropensity per sei mesi

ID query: `9a18bd70-8f90-4bd2-8266-5f6e453e3ee7`
...
## <a name="clas-d365-propensity"></a>CLAS D365 tendenza

Report CLASD365Propensity per sei mesi

ID query: `258fdcac-6e9c-4072-af27-b1b3d97be16c`
...
## <a name="clas-m365-propensity"></a>CLAS M365 tendenza

Report CLASM365Propensity per sei mesi

ID query: `fbe00e32-fdde-4465-b3e4-41bbd021a130`
...
## <a name="teams-usage-3p-apps"></a>Teams App 3P di utilizzo

Report TeamsUsage3PApps per sei mesi

ID query: `42d287be-cc76-4109-a066-f3140ad97fe2`
...
## <a name="teams-usage-workload"></a>Teams di lavoro di utilizzo

Report TeamsUsageWorkload per sei mesi

ID query: `817fe875-acb0-4c45-9201-b7a35a60235a`
...
## <a name="teams-usage-meetings-and-calls"></a>Teams riunioni e chiamate sull'utilizzo

Report TeamsUsageMeetingsAndCalls per sei mesi

ID query: `b7bd73a8-47e8-4c57-b915-445708cfd7bf`
...
## <a name="competency-summary-history"></a>Cronologia di riepilogo delle competenze

Report CompetencySummaryHistory per sei mesi

ID query: `fddab2aa-523d-47f6-90fe-588557306db4`
...
## <a name="training-completion"></a>Completamento del training

Report Completamenti training per sei mesi

ID query: `20f5da57-3c2a-481b-b6a0-ec34d6db14e2`
...
Microsoft Learn report degli ultimi sei mesi

ID query: `0e06c7c3-75ab-4cd5-8178-8cf1a2de49cc`
...
- [Applicazione di esempio per l'accesso ai dati analitici delle informazioni dettagliate dei partner](insights-programmatic-sample-application.md)