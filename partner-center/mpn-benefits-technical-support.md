...
3. Per iniziare a usare un supporto tecnico Microsoft o un supporto tecnico per la firma, è necessario attivare il vantaggio. L'ID di accesso e l'ID contratto verranno visualizzati al termine dell'attivazione. 
    ...
    -   Per attivare il vantaggio, selezionare il pulsante Attiva. L'account utente usato per l'attivazione richiede i ruoli Di amministratore globale o Amministratore partner MPN. Attendere alcuni giorni per consentire l'elaborazione della richiesta di attivazione. 

    - Quando vengono visualizzati l'ID di accesso e l'ID contratto, è possibile usare il supporto tecnico microsoft e il supporto tecnico per la firma (membri Gold e Silver). 

 4. Saranno necessari l'ID di accesso e l'ID contratto la prima volta che si usa il Supporto tecnico Microsoft o il Supporto tecnico Per la firma.  

## <a name="technical-support-entitlement-and-supported-products"></a>Diritti del supporto tecnico e prodotti supportati

Il supporto tecnico fornisce la risoluzione di un problema, un messaggio di errore o una funzionalità specifica che non funziona come previsto.
...
È possibile ottenere queste informazioni solo dal portale di supporto locale di Support for Business. Sfortunatamente, i portali cloud, ad esempio Azure, LCS e così via, non visualizzano queste informazioni.
...
Vedere Piani di supporto partner di seguito per le offerte di supporto a pagamento dei partner
...
È possibile confrontare [i piani di supporto dei partner](https://partner.microsoft.com/support/partnersupport) o vedere di seguito per i piani specifici del partner:
