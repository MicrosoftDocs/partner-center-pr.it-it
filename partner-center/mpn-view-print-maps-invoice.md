...
1.  In centro per i partner selezionare **Impostazioni account**.
...
3.  Compila il modulo. Per il **tipo di problema**, selezionare **non è in grado di gestire il profilo personale**. Includi il tuo ID MPN e ID Microsoft nella descrizione.
...
1.  In centro per i partner selezionare **offerte di appartenenza**, quindi selezionare **disponibile**. 
