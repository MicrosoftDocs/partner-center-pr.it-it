...
>[!NOTE]
>A causa delle modifiche apportate ai tassi di cambio esteri, l'importo esatto delle vendite può variare leggermente da una valuta all'altra. I tassi di cambio vengono calcolati mensilmente. A seconda del momento in cui è avvenuta la transazione, viene applicato il tasso di cambio appropriato. Il tasso di cambio e la frequenza di data per cui è stato forzato sono indicati rispettivamente nel report dei pagamenti nelle colonne exchangeRate e exchangeRateDate.
