...
description: Informazioni sui report di proCloudAscentzione nel dashboard del centro per i partner.
ms.topic: conceptual
...
1. **Top unmanaged** include i maggiori clienti SMB con la massima opportunità per Microsoft. I clienti principali non gestiti più comuni condividono caratteristiche simili a quelle degli account gestiti, con un numero elevato di dipendenti, budget IT di grandi dimensioni e spesa e grandi quantità di potenziali ricavi per Microsoft.
   ...
   - **Top non gestito basato su utenti**: include account con 300 o più dipendenti. Gli account basati sull'utente sono obiettivi ottimali per il primo acquisto o l'espansione di prodotti di sottoscrizione basati sugli utenti, ad esempio M365, d365 o Surface.
