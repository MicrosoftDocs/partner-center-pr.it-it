...
- Le unità di consumo giornaliere per ogni risorsa a consumo nelle sottoscrizioni di Azure per gli ultimi 60 giorni
...
-  **Abbandoni (ultimi 30 giorni)**: clienti senza alcuna sottoscrizione "attiva", "in prova" o "disabilitata"
...
- **Stato sottoscrizione**:
    ...
    - Active: sottoscrizioni che appartengono allo stato "attivo" o "in prova"

    - Sospesa: sottoscrizioni che appartengono allo stato "disabilitato"

    - Deprovisioning: sottoscrizioni che appartengono allo stato "deprovisioning" o "scaduto"
...
-  **Sottoscrizioni totali**: sottoscrizioni nello stato "attivo", "in prova" o "disabilitato"
...
[Panoramica dell'app Analisi del Centro per i Partner per Power BI](power-bi-app-for-direct-partners.md)
