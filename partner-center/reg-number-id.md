...
Per i paesi in cui il numero di registrazione è obbligatorio, l'etichetta sopra la casella di testo indica il tipo di numero richiesto a seconda del paese, ad esempio TIN (codice fiscale) o TRN (Numero di registrazione del traffico).

Se il numero di registrazione è facoltativo, immettere l'ID registrazione aziendale. Non immettere un ID personale.
