...
| CustomerCompanyName | Nome dell'organizzazione del cliente, come indicato in Partner Center. *Molto importante per riconcilare la fattura con le informazioni di sistema.* | *Cliente di test* |
...
| OrderID | Identificatore univoco per un ordine nella piattaforma di fatturazione Microsoft. Può essere utile identificare la sottoscrizione quando si contatta il supporto tecnico. Non usato per la riconciliazione. | *566890604832738111* |
...
| Region | Area a cui si applica l'utilizzo. Usato principalmente per assegnare le tariffe ai trasferimenti di dati, perché le tariffe variano in base all'area. | *Asia Pacifico*, *Europe*, *America Latina*, *America del Nord* |
...
| ConsumedQuantity | Quantità di servizio utilizzata (ad esempio ore o GB) durante il periodo di creazione del report. Include anche l'utilizzo non fatturato dei periodi di report precedenti. | *11* |
...
| PostTaxEffectiveRate | Prezzo per unità al netto delle imposte. Uguale a **PostTaxTotal diviso** per **OverageQuantity**, arrotondato al centesimo più vicino. Oppure, uguale a **PretaxEffectiveRate** più l'importo dell'imposta per unità, arrotondato al centesimo più vicino. | *$ 0,08* |
